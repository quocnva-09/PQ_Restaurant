  ...
  return (
    ...
    <div class="text-sm max-w-sm border border-gray-200 pb-6 rounded-lg bg-[#edbdcd] shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden">
        ...
        <div class="p-5 pb-7">
            ...
            <p class="text-black mt-5">I've been using imagify for nearly two years, primarily for Instagram, and it has been incredibly user-friendly, making my work much easier.</p>
        </div>
        <a href="#" class="text-black underline px-5">Read more</a>
    </div>

    <div class="text-sm max-w-sm border border-gray-200 pb-6 rounded-lg bg-[#cebfab] shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden">
        <div class="flex items-center gap-4 px-5 py-4 bg-red-500/10">
            <img class="h-12 w-12 rounded-full" src={myAssets.user2} alt="userImage2" />
            <div>
                <h1 class="text-lg font-medium text-gray-800">Richard Nelson</h1>
                <p class="text-black">Instagram Influencer</p>
            </div>
        </div>
        <div class="p-5 pb-7">
            <div class="flex gap-0.5">
    ...
    <div class="text-sm max-w-sm border border-gray-200 pb-6 rounded-lg bg-[#c4abce] shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden">
        <div class="flex items-center gap-4 px-5 py-4 bg-red-500/10">
            <img class="h-12 w-12 rounded-full" src={myAssets.user3} alt="userImage3" />
            <div>
                <h1 class="text-lg font-medium text-gray-800">James Washington</h1>
                <p class="text-black">Digital Content Creator</p>
            </div>
        </div>
        <div class="p-5 pb-7">
            <div class="flex gap-0.5">
